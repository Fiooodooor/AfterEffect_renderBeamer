...
ErrorCodesAE gfs_rq_node_wrapper::gfs_node_deserialize(void *in_pointer, std::list<gfsRqItem*> &in_items_list)
{
    ERROR_CATCH_START
    auto *in_object = static_cast<picojson::value::object*>(in_pointer);
...
ErrorCodesAE gfs_rq_node_wrapper::gfs_node_outputs_deserialize(void *in_pointer, std::vector<gfsRqItemOutput*> &in_items_vector)
{
    ERROR_CATCH_START
        auto *in_array = static_cast<picojson::value::array*>(in_pointer);
